...
[System.Serializable]
public struct PlayerAvatarDto : ISaveLoadData, INetworkSerializable
{
    ...
    public PlayerAvatarDto(byte[] codedValue)
    {
    ...
    {
        _codedValue = TextureConverter.GetRawTexture(Resources.Load<Sprite>("Sprites/DefaultAvatar").texture);
    }
